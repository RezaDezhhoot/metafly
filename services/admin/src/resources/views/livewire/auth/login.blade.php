@section('title',__('pages.auth.login'))
        ...
        <div class="login-form login-signin">
            <form wire:submit.prevent="login" class="form" novalidate="novalidate" id="kt_login_signin_form">
                <div class="pb-13 pt-lg-0 pt-5">
                    <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">{{ __('auth.login') }}</h3>
                </div>
                <div class="form-group">
                    <label class="font-size-h6 font-weight-bolder text-dark">{{ __('general.email') }}</label>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between mt-n5">
                        <label class="font-size-h6 font-weight-bolder text-dark pt-5">{{ __('general.password') }}</label>
                    </div>
