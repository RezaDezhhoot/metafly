    ...
    <div class="card card-custom h-100 gutter-b example example-compact">
        ...
        <div class="card-body ">
            <x-admin.form-section>
                ...
                <x-admin.forms.input width="4" type="text" :required="true" id="symbol" label="{{__('general.symbol')}}" wire:model.defer="symbol"/>
                <x-admin.forms.input width="4" type="number" help="t" :required="true" id="amount" label="{{__('general.amount')}}" wire:model.defer="amount"/>
